...
const VideoCallScreen = () => {
  ...
  return (
    <SafeAreaView style={tw`flex-1 justify-center items-center p-5`}>
      ...
      <View
        style={tw`w-full h-75 rounded-xl border-2 border-blue-300 justify-center items-center bg-blue-50 mb-7`}
      >
        <Text style={tw`text-blue-800`}>Video call UI will be here</Text>
      </View>

      <TouchableOpacity
        style={tw`bg-blue-600 py-3 px-10 rounded-full`}
