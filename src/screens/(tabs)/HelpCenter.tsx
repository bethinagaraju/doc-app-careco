...
const HelpCenterScreen = () => {
  ...
  return (
    ...
    >
      <View style={tw`px-4`}>
        <Text style={tw`text-base text-blue-700 mb-6`}>
        ...
        <View style={tw`mb-8`}>
          {helpTopics.map((topic) => (
            <TouchableOpacity
              ...
              style={tw`bg-blue-50 rounded-xl px-4 py-4 mb-3 flex-row items-center justify-between shadow`}
              accessibilityRole="button"
              accessibilityLabel={topic.title}
            >
              <View style={tw`flex-row items-center`}>
                <topic.icon size={22} color="#007bff" />
                <Text style={tw`ml-3 text-base text-blue-800 font-medium`}>
                  {topic.title}
                </Text>
              </View>
        ...
        {/* Contact Support */}
        <View>
          <Text style={tw`text-base font-semibold mb-3 text-blue-800`}>
            Still need help?
          </Text>
          <TouchableOpacity
