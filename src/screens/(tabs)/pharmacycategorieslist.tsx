  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-[#f7fafd]`}>
      ...
      <View style={tw`flex-row items-center px-4 py-2`}>
        <Text style={tw`text-sm text-blue-800`}>Deliver to - </Text>
      ...
      <Modal visible={showLocationModal} transparent animationType="slide">
        <View style={tw`flex-1 justify-end bg-blue-900/10`}>
          <View style={tw`bg-blue-50 rounded-t-xl p-4`}>
            ...
            {locations.map((loc) => (
              <TouchableOpacity
                ...
                style={tw`py-2 border-b border-blue-100`}
              >
      ...
      <View style={tw`px-4 pt-2 pb-1`}>
        <View style={tw`flex-row items-center bg-blue-50 rounded-full px-4 py-2 shadow-sm`}>
      ...
      {/* Section Title */}
      <Text style={tw`px-4 pt-4 pb-2 font-bold text-lg text-blue-900`}>Shop Health Products By Categories</Text>
