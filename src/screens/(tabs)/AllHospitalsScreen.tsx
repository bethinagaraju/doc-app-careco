...
const AllHospitalsScreen = () => {
  ...
  const renderHospitalCard = ({ item }: { item: typeof hospitals[0] }) => (
    <TouchableOpacity
      ...
      style={tw`bg-blue-50 rounded-2xl mx-4 mb-4 shadow-md overflow-hidden`}
    ...
    >
      ...
      <View style={tw`p-4`}>
        ...
        <Text style={tw`text-sm text-blue-600 mt-1`}>{item.location}</Text>
      </View>
    </TouchableOpacity>
  );
  ...
  return (
    ...
    >
      ...
      <View style={tw`px-4 mt-4 mb-3`}>
        <View style={tw`flex-row items-center bg-blue-50 rounded-full px-4 py-2 shadow`}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={tw`text-center mt-10 text-base text-blue-400`}>
            No hospitals found.
          </Text>
        }
      />
