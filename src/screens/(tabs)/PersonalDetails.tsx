...
// // // //       headerBackgroundColor="bg-blue-600"
// // // //       scrollable={true}
// // // //     >
// // // //       <View style={[tw`bg-blue-50 rounded-xl p-4 mx-4`, { elevation: 1 }]}> 
// // // //         <View style={tw`mb-4`}>
// // // //           <Text style={tw`text-sm text-blue-700`}>Full Name</Text>
// // // //           <Text style={tw`text-base text-blue-900 mt-1 font-medium`}>{name}</Text>
// // // //         </View>

// // // //         <View style={tw`mb-4`}>
// // // //           <Text style={tw`text-sm text-blue-700`}>Email</Text>
// // // //           <Text style={tw`text-base text-blue-900 mt-1 font-medium`}>{email}</Text>
// // // //         </View>

// // // //         <View style={tw`mb-4`}>
// // // //           <Text style={tw`text-sm text-blue-700`}>Phone</Text>
// // // //           <Text style={tw`text-base text-blue-900 mt-1 font-medium`}>{phone}</Text>
// // // //         </View>

// // // //         <View style={tw`mb-4`}>
// // // //           <Text style={tw`text-sm text-blue-700`}>Gender</Text>
// // // //           <Text style={tw`text-base text-blue-900 mt-1 font-medium`}>{gender}</Text>
// // // //         </View>

// // // //         <View style={tw`mb-4`}>
// // // //           <Text style={tw`text-sm text-blue-700`}>Date of Birth</Text>
// // // //           <Text style={tw`text-base text-blue-900 mt-1 font-medium`}>{dob}</Text>
// // // //         </View>

// // // //         <View style={tw`mb-4`}>
// // // //           <Text style={tw`text-sm text-blue-700`}>Address</Text>
// // // //           <Text style={tw`text-base text-blue-900 mt-1 font-medium`}>{address}</Text>
// // // //         </View>
// // // //       </View>
// // // //     </PageLayout>
// // // //   );
...
// // //   if (loading) {
// // //     return (
// // //       <PageLayout title="Personal Details" headerBackgroundColor="bg-blue-600">
// // //         <View style={tw`flex-1 justify-center items-center`}>
// // //           <ActivityIndicator size="large" color="#164aa3ff" />
// // //           <Text style={tw`text-blue-700 mt-2`}>Loading your details...</Text>
// // //         </View>
// // //       </PageLayout>
// // //     );
// // //   }
...
// // //     <Text style={tw`text-base text-blue-900 mt-1 font-medium`}>
// // //       {value || 'N/A'}
// // //     </Text>
// // //   </View>
// // // );
...
// //               style={tw`w-32 h-32 rounded-full border-4 border-blue-500`}
// //               resizeMode="cover"
// //             />
// //           ) : (
// //             <View
// //               style={tw`w-32 h-32 rounded-full bg-blue-200 justify-center items-center border-4 border-blue-500`}
// //             >
// //               <Text style={tw`text-blue-800 text-lg font-bold`}>No Image</Text>
// //             </View>
// //           )}
// //           <Text style={tw`text-xl font-bold text-blue-900 mt-3`}>{username}</Text>
// //           <Text style={tw`text-sm text-blue-700`}>{role?.toUpperCase()}</Text>
// //         </View>

// //         <View style={[tw`bg-blue-50 rounded-xl p-4 mx-4 mt-6`, { elevation: 1 }]}>
