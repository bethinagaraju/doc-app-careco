...
const AllSpecialtiesScreen = () => {
  ...
  const renderItem = ({ item }: { item: typeof specialties[0] }) => (
    <TouchableOpacity
      style={[
        tw`bg-blue-50 rounded-3xl py-4 px-2 items-center justify-center shadow-sm elevation-3`,
  ...
  return (
    <View style={tw`flex-1 bg-blue-50`}>
      <PageHeader title="All Specialties" backgroundColor="blue" textColor="#fff" onBackPress={() => navigation.goBack()} />
      {/* Search Bar */}
      <View style={tw`flex-row items-center bg-blue-50 rounded-3xl px-3 py-2.5 mb-5 shadow-sm elevation-3 mx-4 mt-4`}>
