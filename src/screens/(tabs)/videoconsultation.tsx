  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-gray-100`}>
      ...
      <View style={tw`flex-1 p-5 items-center justify-start`}>
        <Text style={tw`text-2xl font-bold mt-8 mb-2 text-blue-800`}>Video Consultation</Text>
        <Text style={tw`text-base text-blue-500 mb-8 text-center`}>Talk to a doctor face-to-face now</Text>
        ...
        <View style={tw`mt-8 bg-blue-50 rounded-xl p-4 w-full`}>
          <Text style={tw`font-bold text-base mb-1 text-blue-800`}>Upcoming Appointment</Text>
