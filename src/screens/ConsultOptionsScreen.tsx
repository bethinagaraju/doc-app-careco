  ...
  return (
    <PageLayout title="Consultation Options" headerBackgroundColor="#219F4D">
      <View style={tw`flex-1 px-4 py-8 justify-center`}>
        <Text style={tw`text-2xl font-bold text-blue-900 mb-7 text-center`}>
          {specialty}
        </Text>
        ...
        <TouchableOpacity
          style={[
            tw`bg-blue-100 border border-blue-300 rounded-[28px] flex-row items-center px-8 mb-7`,
            {
              height: CARD_HEIGHT,
              shadowColor: '#22C55E',
              shadowOpacity: 0.15,
          ...
          activeOpacity={0.9}
        >
          <View style={tw`bg-blue-200 rounded-full w-16 h-16 items-center justify-center mr-7`}>
            <Home size={30} color="#15803D" strokeWidth={2} />
          </View>
          <View style={tw`flex-1`}>
            <Text style={tw`text-[22px] font-bold text-blue-900 mb-1`}>
        ...
        <TouchableOpacity
          style={[
            tw`bg-blue-100 border border-blue-300 rounded-[28px] flex-row items-center px-8`,
            {
              height: CARD_HEIGHT,
              shadowColor: '#22C55E',
              shadowOpacity: 0.15,
