  ...
  return (
    <View style={tw`flex-1 bg-blue-50`}>
      ...
      <ScrollView contentContainerStyle={tw`p-4 pb-10`}>
        <Text style={tw`text-2xl font-bold text-blue-700 mb-4 text-center`}>Privacy Policy</Text>
        <Text style={tw`text-sm text-blue-600 mb-6 text-center`}>Last updated: June 21, 2025</Text>

        <View style={tw`bg-white rounded-xl p-4 mb-4`}>
          <Text style={tw`text-lg font-bold text-blue-700 mb-3`}>Information We Collect</Text>
          <Text style={tw`text-blue-600 leading-6 mb-3`}>
          ...
          <Text style={tw`text-blue-600 leading-6`}>
            This includes personal information like your name, email address, phone number, and professional credentials.
          </Text>
        </View>

        <View style={tw`bg-white rounded-xl p-4 mb-4`}>
          <Text style={tw`text-lg font-bold text-blue-700 mb-3`}>How We Use Your Information</Text>
          <Text style={tw`text-blue-600 leading-6 mb-3`}>
            We use the information we collect to:
          </Text>
          <Text style={tw`text-blue-600 leading-6 ml-4`}>
        ...
        <View style={tw`bg-white rounded-xl p-4 mb-4`}>
          <Text style={tw`text-lg font-bold text-blue-700 mb-3`}>Information Sharing</Text>
          <Text style={tw`text-blue-600 leading-6`}>
        ...
        <View style={tw`bg-white rounded-xl p-4 mb-4`}>
          <Text style={tw`text-lg font-bold text-blue-700 mb-3`}>Data Security</Text>
          <Text style={tw`text-blue-600 leading-6`}>
        ...
        <View style={tw`bg-white rounded-xl p-4 mb-4`}>
          <Text style={tw`text-lg font-bold text-blue-700 mb-3`}>Your Rights</Text>
          <Text style={tw`text-blue-600 leading-6`}>
        ...
        <View style={tw`bg-white rounded-xl p-4 mb-4`}>
          <Text style={tw`text-lg font-bold text-blue-700 mb-3`}>Contact Us</Text>
          <Text style={tw`text-blue-600 leading-6`}>
