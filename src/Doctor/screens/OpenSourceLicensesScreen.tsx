  ...
  return (
    <View style={tw`flex-1 bg-blue-50`}>
      ...
      <ScrollView contentContainerStyle={tw`p-4 pb-10`}>
        <Text style={tw`text-2xl font-bold text-blue-700 mb-2 text-center`}>Open Source Licenses</Text>
        <Text style={tw`text-base text-blue-600 mb-6 text-center`}>Third-party libraries used in this app</Text>

        <View style={tw`bg-white rounded-xl p-4 mb-4`}>
          <Text style={tw`text-lg font-bold text-blue-700 mb-3`}>Acknowledgments</Text>
